...
<!-- NavBar head 2 -->
<!-- End Template -->
    <div style="height: 1000px;" id="bodypage">
      	<div class="video-container">
        	<video autoplay muted loop>
          	<!-- <source src="https://www.dropbox.com/s/7o5pvv7bzoc2x5y/y2mate.com%20-%20Shoes%20by%202GO%20%20Theatrical%20Ad%20Film%20%20Commercial_1080p.mp4?raw=1" type="video/mp4" /> -->
          		<source src="${pageContext.request.contextPath}/video/y2mate.com - Shoes by 2GO  Theatrical Ad Film  Commercial_1080p.mp4" type="video/mp4" />
