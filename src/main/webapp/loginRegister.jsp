...
<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style_loginRegister.css"/>
...
<body>
    ...
    <div class="main">    
        <div class="container a-container" id="a-container">
            <form class="form" id="a-form" method="post" action="CheckLoginServlet?mod=Register">
                ...
                <input class="form__input" type="text" placeholder="Name" name ="txtnameregister">
                <input class="form__input" type="text" placeholder="Email" name = "txtemailregister">
                <input class="form__input" type="password" placeholder="Password" name = "txtpasswordregister">
                <fieldset>
                    <legend>Choose gender</legend>
                    <div class="gender-select-area">
                        <div class="text-center text-justify gender-select man" id="gender-1">Man<i
                                class="fa-solid fa-mars"></i></div>
                        <div class="text-center text-justify gender-select clearfix woman" id="gender-2"
                            style="float: right;">Woman<i class="fa-solid fa-venus"></i></div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/js/loginRegister.js"></script>
